...
#ifndef DIFFERENTIATION_SRC_ACITVATIONS_SQ_RELU_H_
#define DIFFERENTIATION_SRC_ACITVATIONS_SQ_RELU_H_

#include "../data/DenseMatrix.h"
#include "../data/SArray.h"
#include "Activation.h"

struct SqReLU : Activation {
...
#endif    // DIFFERENTIATION_SRC_ACITVATIONS_SQ_RELU_H_
